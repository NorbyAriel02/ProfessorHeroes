...
public class UIOptionController : MonoBehaviour
{
    ...
    void LoadData()
    {
        ...
        shadows.value = settings.ShadowValue;
    ...
    public void ShadowValue()
    {        
        settings.ShadowValue = (int)shadows.value;
        GameManager.Instance.SetQualityShadows(settings.ShadowValue);
    }
