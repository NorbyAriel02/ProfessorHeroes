...
public class ChildrenController {
    ...
    public static GameObject GetFather(GameObject child)
    {
    ...
    public static void MakeSonOfFather(GameObject father, GameObject Child, bool wordPosStays = false)
    {
        Child.transform.SetParent(father.transform, wordPosStays);
    }
    public static void MakeSonOfFather(GameObject father, GameObject Child, Vector3 pos)
    {
